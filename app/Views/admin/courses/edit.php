...
<div class="card">
    <div class="card-body">
        <?= form_open('/admin/courses/' . $course['id'], ['class' => 'needs-validation', 'novalidate' => '']) ?>
        <?= csrf_field() ?>
            ...
            <div class="col-md-6">
                <div class="mb-3">
                    ...
                    <input type="text" 
                           ...
                           id="moodle_id" 
                           name="moodle_id" 
                           value="<?= old('moodle_id', $course['moodle_id']) ?>" 
        ...
        <div class="d-flex gap-2">
            ...
            <a href="/admin/courses/<?= $course['id'] ?>" class="btn btn-outline-secondary">Cancel</a>
        </div>
